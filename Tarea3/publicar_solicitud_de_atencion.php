...
<div>
    ...
    <form enctype="multipart/form-data" method="post" id="solicitud-form" action="./BackEnd/procesar_form_solicitud.php"
          onsubmit="return solicitudeValidator();">
        <br>
    ...
    <br>
        ...
        <br>
        <textarea rows="8" cols="40" maxlength="500" id="sintomas-solicitante" name="sintomas-solicitante"
                  placeholder="Indique aquí sus síntomas."></textarea>
        <br>
